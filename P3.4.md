...
1. Login as the user student for SparkSQL activities
   ...
   1.1 Open the $\color{red}{\textsf{NOTEBOOK 3.4 Spark SQL.ipynb}}$ in your JupyterLab’s de directory. For each cell:
   - Review and understand the code, and
   - Run the code and observe its output

2. More exercixes on SparkSQL

   2.1 Write PySpark code **with Spark SQL** for the following past years question 202401: Question 4
   > If you have carried out the Pre-Practical Steps, the **marks.csv** file should already be in HDFS.

   2.2 Write PySpark code **with Spark SQL** for the following past years question 202305: Question 4
