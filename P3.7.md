...
4. **Advanced**: Assessing Hive using PySpark
   ...
   4.1 Change to the user student before start the JupyterLab service
      ~~~bash
   ...
   4.4 Upload the downloaded NOTEBOOK 3.7 PySpark and Hive.ipynb
   
   4.5 Review and then run the code in the created virtual environment, i.e., de-venv.

   4.6 Deactivate the virtual environment once you no longer need to work in the environment.
      ~~~bash
