...
3. Run Hive CLI Commands
   ...
   3.3 Create a new database
    ...
    3.5 Create Hive tables
      ...
      v. **Exercise**: Create another data file in HDFS, and append a set set of data in the Sales table. Then, retrieve updated records from the Sales table. Here we assume that the sales_new2.csv file is new created with four records in your HDFS’ directory named data. 
      ~~~bash
