...
3. Run Hive CLI Commands
   ...
   3.2 Run HDFS commands from the beeline prompt
      ...
      0: jdbc:hive2://> dfs -ls /user/hduser;
      ~~~
   ...
   3.3 Create a new database
    ...
    3.5 Create Hive tables
      ...
      ~~~bash
      > CREATE TABLE Sales (ID INT, DESCRIPTION STRING, UNIT_PRICE DOUBLE, QUANTITY INT) COMMENT 'This is the Sales table stored as textfile' ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t' STORED AS TEXTFILE;
      ~~~
