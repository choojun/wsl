...
2. Test it using the PySpark Interactive Shell: Word count example
   ...
   2.4 Check the HDFS current working directory for the newly created directory’s contents, and use the head, tail and cat commands to view one of the part files
      ~~~bash
      $ hdfs dfs -ls wc
