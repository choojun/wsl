# PRACTICAL 3.0: PySpark Environment and PySpark Shell
...
2. Test it using the PySpark Interactive Shell: Word count example
   ...
   2.4 Check the HDFS current working directory for the newly created directory’s contents.
      ~~~bash
      $ hdfs dfs -ls wc
      ~~~
      ...
      Use the head, tail, and cat commands to view one of the part files and observe the difference in their output.
      ~~~bash
      $ hdfs dfs -head wc/part-00000
      $ hdfs dfs -tail wc/part-00000
      $ hdfs dfs -cat wc/part-00000
      ~~~
