...
4. Create User Directories in HDFS
   ...
   3.1 Create a HDFS user directory for student:
    ...
    3.2 Change ownership for the created directory:
      ...
      > 
      > **Example**, to change the permission of the file shakespeare.txt to 664. You may download file using the same command and upload downloaded file (from Ubuntu to HDFS) in steps 5.2 and 5.3, respectively.
      > ~~~bash
