...
5. More exercixes on PySpark RDD
   ...
   5.1 Write PySpark code for the following past years question 202405: Question 4
   > If you have carried out the Pre-Practical Steps, the data.txt file should already be in HDFS.

   5.2 Write PySpark code for the following past years question 202301: Question 4
