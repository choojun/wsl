...
2. More exercixes on DataFrame
   ...
   2.1 Write PySpark code for the following past years question 202401: Question 4 (a) - (e)
...
3. Sample Code for Spark DataFrames’ Advanced Operations

In JupyterLab, open NOTEBOOK 3.2(b) Spark DataFrames - Advanced Operations.ipynb. 

For each cell,
   - Review and understand the code, and
   - Run the code and observe its output.

4. Sample Code for Spark DataFrames File IO

In JupyterLab, open NOTEBOOK 3.2(c) Spark DataFrames File IO.ipynb. 
