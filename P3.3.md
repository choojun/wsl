# PRACTICAL 3.3: Spark User-Defined Functions (UDFs)
...
1. Login as the user student for SparkSQL activities
   ...
   1.2 Open the $\color{red}{\textsf{NOTEBOOK 3.3 Spark User-Defined Functions (UDFs).ipynb}}$ in your JupyterLab’s de directory. For each cell:
   - Review and understand the code, and
   - Run the code and observe its output

2. More exercixes on Spark UDF

   2.1 Write PySpark code **with Spark UDF** for the following past years question 202401: Question 4 (f) - (g)
