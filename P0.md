...
6. Copy required files for practical activities
   ...
   6.2 Copy the contents of the sample_code folder from your Windows 11's drive (e.g. C:\ drive) to the distro’s de-prj folder in the local OS (i.e. Ubuntu):
     ~~~bash
...
7. Create a virtual environment and setup the virtual environment for Python programming with JupyterLab
   ...
   7.1 Create a project folder (e.g., de-prj)
     ~~~bash
     student@MyPC:~$ mkdir de-prj
     ~~~
