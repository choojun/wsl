# Pratical 0: Required preparatory steps for each practical session (applicable to any laboratory PC OR following each restoration of the WSL distro)
...
6. **Applicable after P1 and beyond**: Create a virtual environment
...
7. **Optional - Applicable after P2 and beyond**: Copying files
...
8. **Optional - Applicable after P2 and beyond**: To put (upload) the data folder from the student’s home directory to HDFS
   ~~~bash
