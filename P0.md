...
3. How to format Namenode of Hadoop?
   ...
   Refer to step 11 of Section E7 at URL https://choojun.github.io/wsl_hadoop
   
   Kindly note that all data stored in HDFS will be irrevocably lost upon formatting.
