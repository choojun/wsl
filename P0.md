...
7. Create a virtual environment and setup the virtual environment for Python programming with JupyterLab
   > Hints: This is a good practice for starting a new research project, e.g. your assignment.
...
4. Copying files - **Applicable for P2 and beyond**
   ...
   > Syntax: cp -r /mnt/<source drive>/[source path in Windows] [destination path in Ubuntu].
   > 
   > Example:
   > ~~~bash
   ...
   > 
   > Example 1 Copy entire directory:
   > ~~~bash
   > $ cp -r /home/student/sample_data /mnt/c/
   > ~~~
   > > Please ensure that you have the source directory, i.e., /home/student/sample_data, before performing this command.
   > 
   > Example 2 : Copy its contents (both files and sub-directories)
   > ~~~bash
   > $ cp -r /home/student/wordcount/* /mnt/c/wordcount/
   > ~~~
   > > Please ensure that you have the content in the source directory, i.e., /home/student/wordcount, with at least either a file or directory, and also that you have created the targeted folder, i.e., c:\wordcount, before performing this command.


5. To put (upload) the data folder from the student’s home directory to HDFS - **Applicable for P2 and beyond**
   ~~~bash
   $ hdfs dfs -put /home/student/sample_data  .
   ~~~
   > Please ensure that you have the source directory, i.e., /home/student/sample_data, before performing this command.
